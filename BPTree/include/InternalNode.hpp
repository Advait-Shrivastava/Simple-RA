...
public:
    ...
    void delete_key(const Key& key,TreePtr leftSib,TreePtr rightSib, TreePtr ptrToParent, int positionOfParent) override; // TO BE IMPLEMENTED
    ...
    void delete_key_checks(const Key &key);
    void leftBorrow(TreePtr leftSib,TreePtr rightSib, TreePtr parentPtr, int posOfParent,InternalNode *thisNode);
    void rightBorrow(TreePtr leftSib,TreePtr rightSib, TreePtr parentPtr, int posOfParent,InternalNode *thisNode);
    void leftMerge(TreePtr leftSib,TreePtr rightSib, TreePtr parentPtr, int posOfParent,InternalNode *thisNode);
    void rightMerge(TreePtr leftSib,TreePtr rightSib, TreePtr parentPtr, int posOfParent,InternalNode *thisNode);
